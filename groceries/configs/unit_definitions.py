...
metric_imperial_formatting = {
    ...
    'volume': [
        ...
        {'unit': 'ts', 'checks': [less_than(0.015), greater_than_or_equal_to(0.005 / 4),
                                  fraction_of(dimensions['volume']['ts']['scale'])]},
        {'unit': 'ss', 'checks': [less_than(0.01), greater_than_or_equal_to(0.015 / 4),
                                  fraction_of(dimensions['volume']['ss']['scale'])]},
...
metric_formatting = {
    ...
    'volume': [
        ...
        {'unit': 'l', 'checks': [greater_than_or_equal_to(0.5), fraction_of(1)]},
        {'unit': 'dl', 'checks': [greater_than_or_equal_to(0.01), less_than(1)]},
        {'unit': 'ts', 'checks': [less_than(0.015), greater_than_or_equal_to(0.005),
                                  fraction_of(dimensions['volume']['ts']['scale'])]},
        {'unit': 'ss', 'checks': [less_than(0.01), greater_than_or_equal_to(0.015),
                                  fraction_of(dimensions['volume']['ss']['scale'])]},
        {'unit': 'ml', 'checks': [less_than(0.1)]},
    ],
    'hvitløk': [
