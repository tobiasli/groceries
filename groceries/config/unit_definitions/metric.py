...
from groceries.config.unit_definitions import constants as c
_units = {
        'length': {
            'm': {
...
_formatting={
        ...
        'volume': [
            ...
            {'unit': 'ts', 'checks': [c.less_than(0.015), c.greater_than_or_equal_to(0.005),
                                      c.fraction_of(_units['volume']['ts']['scale'])]},
            {'unit': 'ss', 'checks': [c.less_than(0.01), c.greater_than_or_equal_to(0.015),
